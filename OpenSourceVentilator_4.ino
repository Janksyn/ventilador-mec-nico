...
#ifdef MEGA // This configuration applies to an Arduino Mega controller with Atmega2560 processor 
...
#define pin_Stepper_Step       24
#define StepGen
#endif

#ifdef disableMotorctrl
#define pin_Stepper_Disable    22
#endif
...
#endif
#ifdef PCF8574LCDDisplay
 Wire.beginTransmission(0x3F);     // I2C Address of the PCF8574 chip 
